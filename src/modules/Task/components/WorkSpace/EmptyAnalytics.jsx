...
import { instaAnalytics, instaRightAnalytics } from '../../../../constant/app/workSpace/WorkSpace';
...
const EmptyAnalytics = () => {
  return (
    <div className='analytics-main-container'>
      ...
      <div className='analytics-main-heading-blur'>
        <span className='analytics-heading'>Instagram Post Insights</span>
        <div className='analytics-container flex-row align-center '>
          {instaAnalytics?.map((item) => (
            <div
