...
import '../../styles/WorkSpace/Reels.css';

import instaReels, { Reels } from '../../../../constant/app/campaign/campaignReel';

import Avatar from '../../../../components/commonComponents/avatar/Avatar';
import { AvatarIcon } from './Instagram';
    ...
    <div className='reels-container flex-row align-center justify-center'>
      <div className='reels flex-row align-center justify-center'>
        ...
        <div className='reel flex-row space-between'>
          ...
          <div className='icons-wrapper flex-column align-center space-between pr-5'>
            <div>
              <img
                src={ICONS?.instaIconCamera}
                alt='reels'
              />
            </div>
